...
$(function() {
    ...
    $(".image-preview-input input:file").change(function (){     
        ...
        reader.readAsDataURL(file);
			...
			<form action="{{ route('siswa.update',$tb_m_siswa->id) }}" method="post" enctype="multipart/form-data" >
...
<div class="row mb-3">
				...
				<div class="col-md-6 col-lg-4 col-xlg-3">			
					<div class=" {{$errors->has('nama_panggilan') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->nama_panggilan }}" class="form-control" name="nama_panggilan" required>
  ...
  <div id="Ortu" class="tab-pane fade in">
	...
	<div class="row mb-3">
					...
					<div class=" {{$errors->has('nama_ayah') ? 'has-error' : ''}}">
								...
								<input type="text"  value="{{ $tb_m_siswa->tb_m_ortu->nama_ayah }}" class="form-control" name="nama_ayah" >
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class=" {{$errors->has('ttl_ayah') ? 'has-error' : ''}}">
								<label class="control-label">Tempat Tanggal Lahir</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->ttl_ayah }}" class="form-control"  name="ttl_ayah" >
...
<div class="col-md-6 col-lg-4 col-xlg-3">
					...
					<div class=" {{$errors->has('penghasilan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->penghasilan_ibu }}" class="form-control" ] name="penghasilan_ayah" >
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					...
					<div class=" {{$errors->has('alamat_no_telepon_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->alamat_no_telepon_ayah }}" class="form-control"  name="alamat_no_telepon_ayah" >
