          ...
          <div class="col-md-4 col-lg-auto col-xlg-3">
                        <div class="card card-hover" id="search">
                            <div class="box bg-light ">
                                <h1 class="font-light text-black text-center"><img class="img-circle" src="{{ asset('img/Fotosiswa/'.$data->foto) }}" style="min-height:175px; min-width:185px;   max-height:175px; max-width:185px; margin-top:7px;"></h1>
