		...
		<div class="row mb-3">		
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class=" {{$errors->has('kewarganegaraan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->kewarganegaraan_ayah }}" class="form-control"  name="kewarganegaraan_ayah" readonly>
...
<div class="col-md-6 col-lg-4 col-xlg-3">
					...
					<div class=" {{$errors->has('status_yatim') ? 'has-error' : ''}}">
						...
						<input type="radio" class="radio-control" name="status_yatim" 
								...
								<input type="radio" class="radio-control" name="status_yatim"  
								value="-" {{ $tb_m_siswa->status_yatim == '-' ? 'checked' : '' }} disabled>-&nbsp&nbsp			@if ($errors->has('status_yatim'))
									<span class="help-blocks">
...
<div class="col-md-6 col-lg-4 col-xlg-3">					
  <div class=" {{ $errors->has('foto') ? ' has-error' : '' }}">
              <label >Foto</label>  
              <img src="{{ asset('img/Fotosiswa/'.$tb_m_siswa->foto) }}" style="max-height:270px; max-width: 270px; margin-top:7px;">
              @if ($errors->has('foto'))
                            <span class="help-block">
