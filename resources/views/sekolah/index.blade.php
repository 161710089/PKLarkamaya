...
<td  colspan="5" class="text-center ">Facebook </td>
<td  colspan="5" class="text-center ">Instagram </td>
<td  colspan="5" class="text-center ">Twitter </td>
...
<td colspan="5" class="text-center">Action</td>
                    ...
                    <tbody>
                      ...
                      <tr >
                        ...
                        <td id="valagency" colspan="5" class="text-center ">{{ $data->Facebook }}</td>
                        <td id="valagency" colspan="5" class="text-center ">{{ $data->Instagram }}</td>
                        <td id="valagency" colspan="5" class="text-center ">{{ $data->Twitter }}</td>
