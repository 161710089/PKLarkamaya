...
<td colspan="5" class="text-center">Action</td>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="5" class="text-center ">{!! $data->deskripsi !!}</td>
                        ...
                        <td>
                            <a class="btn btn-warning" href="{{ route('artikel.show',$data->id) }}">Show</a>
                        </td>   
                        <td>
                            <a class="btn btn-warning" href="{{ route('artikel.edit',$data->id) }}">Edit</a>
                        </td>
                        <td>
                            <button onclick="deleteArtikel('{{$data->id}}')" class="btn btn-danger">delete</button>
                        </td>
                      </tr>
                      @endforeach   
                    </tbody>
