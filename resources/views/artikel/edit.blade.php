...
<div class="col-md-6 col-lg-4 col-xlg-3">
          <div class="form-group {{$errors->has('waktu') ? 'has-error' : ''}}">
                ...
                <input type="datetime-local" value="{{ $tb_m_artikel->waktu }}" class="form-select" name="waktu" required>
                @if ($errors->has('waktu'))
                  <span class="help-blocks">
      ...
      <div class="col-md-6 col-lg-4 col-xlg-3">
          <div class="form-group {{$errors->has('slug') ? 'has-error' : ''}}">
                ...
                <input type="text" value="{{ $tb_m_artikel->slug }}" class="form-control" name="slug" required>
                @if ($errors->has('slug'))
                  <span class="help-blocks">
...
<div class="col-md-12 col-lg-12 col-xlg-12">          
            ...
            <div class="input-group image-preview">
                <input type="text" value="{{ asset('img/Fotoartikel/'.$tb_m_artikel->foto) }}" class="form-control image-preview-filename" disabled="disabled"> <!-- don't give a name === doesn't send on POST/GET -->
